          ...
          <div className="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="shadow-sm h-full">
              <CardHeader className="pb-2">
                <CardTitle className="text-[#425166]">
...
function StatCard({
  ...
  return (
    <div
      className={`p-4 rounded-lg ${iconBgLight} transform transition-all duration-300 hover:scale-105`}
    >
      <div className="flex items-center gap-3 mb-2">
        <div
          className={`w-10 h-10 rounded-full ${iconBg} flex items-center justify-center text-white`}
        >
          {icon}
        </div>
      </div>
      ...
      <div
        className={`text-xs mt-1 ${
          isPositive ? "text-[#23c16b]" : "text-[#fa5a7d]"
        }`}
      >
        {change}
      </div>
