...
export default function ChatApp() {
  ...
  const selectedConversation: ConversationType | null =
    selectedGroup && selectedOtherUserId
      ? {
          id: selectedGroup.id,
        ...
        <div className="flex-1 overflow-y-auto">
          {groupsPagination.isLoading && joinedGroups.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center p-8 text-center">
              ...
              <h3 className="font-medium text-gray-500 mb-1">No conversations found</h3>
              <p className="text-sm text-gray-400">
                {searchQuery ? "Try adjusting your search" : "You haven't started any conversations yet"}
              </p>
            </div>
          )}
        </div>
        ...
        {groupsPagination.totalCount > 0 && (
          <div className="p-3 border-t border-gray-200 bg-gray-50">
            <div className="text-xs text-gray-500 text-center">
              Showing {filteredGroups.length} of {groupsPagination.totalCount} conversations
