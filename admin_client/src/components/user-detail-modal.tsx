...
export function UserDetailModal({
  ...
  const handleChatWithUser = async () => {
    ...
    try {
      ...
      console.log(
        "[UserDetailModal] Saved pending chat user to localStorage:",
        chatData
      );
  ...
  const handleToggleUserState = async () => {
    ...
    try {
      setUpdating(true);
      const newState: "Active" | "Locked" =
        user.state === "Active" ? "Locked" : "Active";
          ...
          <div className="bg-white space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="flex items-center space-x-2 text-gray-600 text-sm">
                  ...
                  <span>
                    Last online: {formatLastOnline(user.lastOnlineAt)}
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <InfoRow
                  label="Last Online"
                  value={formatDate(user.lastOnlineAt)}
                />
              </div>
            </div>
