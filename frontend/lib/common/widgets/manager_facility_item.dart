...
class ManagerFacilityItem extends StatefulWidget {
  ...
  @override
  State<ManagerFacilityItem> createState() => _ManagerFacilityItemState();
}

class _ManagerFacilityItemState extends State<ManagerFacilityItem> {
  int _activeIndex = 0;

  void _navigateToManagerHome() {
