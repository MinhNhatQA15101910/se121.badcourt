...
public class GroupHubTracker : ITracker
{
    private static readonly Dictionary<string, List<string>> OnlineUsers = [];

    public Task<bool> UserConnectedAsync(string userId, string connectionId)
    {
        Console.WriteLine($"[GroupHubTracker] UserConnected: {userId}, ConnectionId: {connectionId}");
    ...
    {
        Console.WriteLine($"[GroupHubTracker] UserDisconnected: {userId}, ConnectionId: {connectionId}");
